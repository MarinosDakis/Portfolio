  ...
  const data = [
    {
      ...
      img: "assets/charbel_rizk_headshot.jpg",
    ...
    },
    {
      ...
      img: "assets/chris_salboudis_headshot.png",
      icon: "assets/temp.png",
    ...
    },
    {
      ...
      img: "assets/loucia_nearchou_headshot.jpg",
      icon: "assets/temp.png",
  ...
  return (
    <div className="testimonials" id="testimonials">
      ...
      <div className="container">
        {data.map((d) => (
          <div key={`${d.name}-picture`} className={d.featured ? "card featured" : "card"}>
            <div className="top">
